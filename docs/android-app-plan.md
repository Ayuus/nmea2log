...
3. ✅ **Confirmed, real Samsung Galaxy S23**, 2026-09-02: Chaquopy (17.0.0) embeds the unmodified `nmea2000processor` package unchanged, and `ebl_reader.iter_frames()` correctly decoded a real, bundled 5&nbsp;MB `.ebl` sample end-to-end — 236,795 real CAN frames, correct timestamps (2026-07-29 12:26:00&ndash;12:29:36), and a PGN distribution matching exactly what's expected on this boat's network (127237/127251/127250 autopilot, 65341 Simnet, 129025 position, engine PGNs, etc.). The single biggest architectural bet of the whole plan holds.
